  ...
  const CardContent = () => (
    <div className="relative">
      ...
      >
        ...
        <div className="card-body px-3 py-8 w-full h-[195px]">
          <div className="flex justify-between">
            <p
              className={`card-title text-xs font-semibold ${isSoldOut ? 'text-gray-500' : 'text-primary'}`}
            >
              {property?.title}
            </p>
            <div className="flex gap-1 items-center">
              <div className="flex gap-[2px] items-center">
                ...
                <p
                  className={`text-[10px] ${isSoldOut ? 'text-gray-500' : ''}`}
                >
                  {property.bedrooms}
                </p>
              </div>
          ...
          <p
            className={`text-xs font-medium mt-4 ${isSoldOut ? 'text-gray-500' : ''}`}
          >
            {property.street}
            {property.location}
          </p>
          ...
          <div className="mt-2 flex justify-between">
            <p
              className={`font-semibold ${isSoldOut ? 'text-gray-500 line-through' : 'text-customPrimary'}`}
            >
              &#x20A6; {property.budget}
            </p>
          </div>
