      ...
      >
        ...
        <div className="card-body px-3 py-8 w-full h-[195px] ">
          <div className="flex justify-between ">
            ...
            <div className="flex gap-1 items-center">
              <div className="flex gap-[2px] items-center">
                ...
                <p className="text-[10px]">{property.bedrooms}</p>
              </div>
              <div className="flex gap-[2px] items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-[10px] ">{property.bathrooms}</p>
                <p className="text-[10px]">{property.propertySize} sqm</p>
              </div>
            </div>
          </div>
          ...
          <Link href={`/property/${property.slug?.current}`}>
            <button className="text-white bg-primary text-base px-3 py-2 -mr-3 rounded-br-md flex float-end -mb-8">
              View Full Details
            </button>
          </Link>
        </div>
