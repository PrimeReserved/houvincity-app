...
export default function Privacy() {
  return (
    <div className="p-20">
      <h1 className="pt-20 text-4xl pb-10">Privacy Policy</h1>
      ...
      <h3 className="py-5 text-2xl">Interpretation</h3>
      <p>
      ...
      <h3 className="py-5 text-2xl">Definitions</h3>
      ...
      <h2 className="py-5 text-3xl">Collecting and Using Your Personal Data</h2>
      <h3 className="py-5 text-2xl">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      <p>
      ...
      <h3 className="py-5 text-2xl">Use of Your Personal Data</h3>
      ...
      <ul className="py-2 list-outside list-disc">
        ...
        <li>
          <p>
            ...
            such as a mobile application&lsquo;`s push notifications regarding
      ...
      <h3 className="py-5 text-2xl">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 className="py-5 text-2xl">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 className="py-5 text-2xl">Delete Your Personal Data</h3>
      <p>
      ...
      <h3 className="py-5 text-2xl">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="py-5 text-2xl">Security of Your Personal Data</h3>
      <p>
      ...
      <h2 className="py-5 text-3xl">Children&lsquo;`s Privacy</h2>
      <p>
      ...
      <p>
        ...
        third party&lsquo;`s site. We strongly advise You to review the Privacy
      ...
      <h2 className="py-5 text-3xl">Changes to this Privacy Policy</h2>
      <p>
