...
export default function Terms() {
  return (
    <div className="p-20">
      <h2 className="pt-20 text-4xl pb-10">Terms and Conditions</h2>
      <p>Last updated: May 06, 2024</p>
      <p>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h2 className="py-5 text-3xl">Interpretation and Definitions</h2>
      <h3 className="py-5 text-3xl">Interpretation</h3>
      <p>
      ...
      <h3 className="py-5 text-3xl">Definitions</h3>
      <p>For the purposes of these Terms and Conditions:</p>
      <ul className="py-2 list-outside list-disc">
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Houvincity.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              className="text-primary hover:text-customPrimary"
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Houvincity, accessible from{" "}
            <a
              className="text-primary hover:text-customPrimary"
              href="https://www.houvincity.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.houvincity.com
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="py-5 text-3xl">Acknowledgment</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Links to Other Websites</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Termination</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Limitation of Liability</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Governing Law</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Disputes Resolution</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">For European Union (EU) Users</h2>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which You are
        resident.
      </p>
      <h2 className="py-5 text-3xl">United States Legal Compliance</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Severability and Waiver</h2>
      <h3 className="py-5 text-3xl">Severability</h3>
      <p>
      ...
      <h3 className="py-5 text-3xl">Waiver</h3>
      <p>
      ...
      <h2 className="py-5 text-3xl">Translation Interpretation</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Changes to These Terms and Conditions</h2>
      <p>
      ...
      <h2 className="py-5 text-3xl">Contact Us</h2>
      <p>
      ...
      <ul className="py-2 list-outside list-disc">
        <li>
          <p>By email: info@houvincityltd.com</p>
        </li>
        <li>
          <p>
            ...
            <a
              className="text-primary hover:text-customPrimary"
              href="https://www.houvincity.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.houvincity.com/contact
            </a>
          </p>
        </li>
        <li>
          <p>By phone number: +2348034652178</p>
        </li>
      </ul>
    </div>
  );
