    ...
    <div>
      <div className="hero min-h-[30rem] bg-white">
        <div className="z-0 flex flex-col items-center mt-[5rem] justify-center w-full gap-4 p-4 text-center ">
          <div className="md:max-w-[45rem] mt-[4rem]">
            <h1 className="text-[25px] md:text-[30px] lg:text-[40px] text-[#040A3B] font-medium md:font-semibold">
              Never Miss A Live Site Inspection
            </h1>
          ...
          <form onSubmit={handleSubmit} className="md:w-[60%] w-[100%]">
            ...
            {!submitted && (
              <button
                className="btn border-none absolute text-white -ml-[8rem] md:-ml-[10rem] mt-2 md:mt-5 text-[12px] w-[7rem] md:w-[8rem]  h-[2.5rem] bg-[#6DBA3A] rounded-md hover:border-primary hover:bg-white hover:text-primary hover:outline hover:outline-primary hover:border-2"
                type="submit"
              >
                Subscribe
              </button>
...
export default Newsletter__old;
